...
Use the **Confirmed MVP scope** section of `CONTEXT.md` as committed requirements. Its **Deferred / post-MVP** section is excluded from MVP delivery; its **Open decisions** section identifies details to verify or specify at the relevant implementation step.
