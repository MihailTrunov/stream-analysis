...
- MVP permits one active batch evaluation at a time. A second launch reports that an evaluation is already running, while completed-result review remains available. Queuing and parallel batch evaluations are deferred.
